...
<table width="1073" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="1073"><font size="+2"><strong>KONFIRMASI TRANSFER</strong></font></td>
          </tr>
  </table>
        <p align="left">&nbsp;</p>
  <table width="1181" border="1" cellspacing="0" cellpadding="0">
          <tr>
            <td width="31"><div align="center">No</div></td>
            <td width="137"><div align="center">Id Konfirmasi</div></td>
            <td width="111"><div align="center">Id Pengiriman</div></td>
            <td width="222"><div align="center">Nama Pembeli</div></td>
            <td width="183"><div align="center">Transfer (Rp)</div></td>
            <td width="163"><div align="center">Keterangan </div></td>
            <td width="163"><div align="center">Tanggal</div></td>
            <td width="153"><div align="center">Gambar </div></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
