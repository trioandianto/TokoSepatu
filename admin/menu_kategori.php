...
<table width="1083" height="109" border="0" cellpadding="0" cellspacing="0">
  ...
  <table width="598" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><strong><font size="+2">DATA KATEGORI</strong></td>
              <td width="348"><div align="right"><a href="tambah_kategori.php">Add data </a></div></td>
            </tr>
</table>
 <?php
  ...
  ?>
<p align="left">&nbsp;</p>
          <table width="909" border="1" cellspacing="0" cellpadding="0">
            <tr>
              <td width="39"><div align="center">No</div></td>
              <td width="96"><div align="center">Kode </div></td>
              <td width="393"><div align="center">Nama Kategori</div>                <div align="center"></div></td>
...
?>
    <tr bgcolor=<?php echo $color; ?>>
     ...
     <td width="194"><div align="center"><a href="edit_kategori.php?kode_kategori=<? echo $baris[0];?>">Edit</a>
     </div></td>
