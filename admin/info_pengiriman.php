...
<table width="1082" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><font size="+2">DATA INFO PENGIRIMAN</font></td>
            <td width="149"><a href="tambah_info_pengiriman.php">Add Data </a></td>
          </tr>
  </table>
  <p align="left">&nbsp;</p>
        <table width="1210" height="51" border="1" cellpadding="0" cellspacing="0">
          <tr>
            <td width="31"><div align="center">No</div></td>
            <td width="169"><div align="center">Id Pengiriman</div></td>
            <td width="169"><div align="center">Nomer Transaksi</div></td>
            <td width="185"><div align="center">Nama Penerima </div></td>
            <td width="233"><div align="center">Nomer Resi</div></td>
            <td width="163"><div align="center">Status Pembayaran</div></td>
            <td width="244"><div align="center">Tanggal Barang Dikirim</div></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
