...
<table width="598" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="38" ><strong><font size="+2">EDIT DATA BARANG</strong>              <div align="right"></div></td>
          </tr>
        </table>
        <p>&nbsp;</p>
        <table width="571" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="9">:</td>
            <td width="362"><label for="id_barang1"></label>
            <input type="text" name="id_barang1" id="id_barang1" /></td>
          </tr>
          <tr>
            <td height="32">Nama Barang</td>
            <td>:</td>
            <td><label for="nama_barang1"></label>
            <input type="text" name="nama_barang1" id="nama_barang1" /></td>
          </tr>
          <tr>
            <td height="28" >Harga Barang (Rp)</td>
            <td>:</td>
            <td><label for="harga_barang1"></label>
            <input type="text" name="harga_barang1" id="harga_barang1" /></td>
          </tr>
          <tr>
            <td height="28">Stock</td>
            <td>:</td>
            <td><label for="stock1"></label>
            <input type="text" name="stock1" id="stock1" /></td>
          </tr>
          <tr>
            <td height="28">Gambar </td>
            <td>:</td>
            <td><label for="gambar1"></label>
            <input type="file" name="gambar1" id="gambar1" /></td>
          </tr>
          <tr>
            <td height="28">Deskripsi</td>
            <td>:</td>
            <td><label for="deskripsi1"></label>
            <textarea name="deskripsi1" id="deskripsi1" cols="45" rows="5"></textarea></td>
          </tr>
          <tr>
            <td height="28">Kategori</td>
            <td>:</td>
            <td><label for="kategori1"></label>
              <select name="kategori1" size="1" id="kategori1">
